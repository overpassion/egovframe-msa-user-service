...
class AuthorizationApiControllerTest {
    ...
    private final Integer AUTHORIZATION_NO = GIVEN_DATA_COUNT + 1;
    private final String INSERT_AUTHORIZATION_NAME = AUTHORIZATION_NAME_PREFIX + "_" + AUTHORIZATION_NO;
    private final String INSERT_URL_PATTERN_VALUE = URL_PATTERN_VALUE_PREFIX + "_" + AUTHORIZATION_NO;
    private final String INSERT_HTTP_METHOD_VALUE = HTTP_METHOD_VALUE_PREFIX + "_" + AUTHORIZATION_NO;
    private final Integer INSERT_SORT_SEQ = AUTHORIZATION_NO;

    private final String UPDATE_AUTHORIZATION_NAME = AUTHORIZATION_NAME_PREFIX + "_" + (AUTHORIZATION_NO + 1);
    private final String UPDATE_URL_PATTERN_VALUE = URL_PATTERN_VALUE_PREFIX + "_" + (AUTHORIZATION_NO + 1);
    private final String UPDATE_HTTP_METHOD_VALUE = HTTP_METHOD_VALUE_PREFIX + "_" + (AUTHORIZATION_NO + 1);
    private final Integer UPDATE_SORT_SEQ = AUTHORIZATION_NO + 1;
    ...
    void 인가_다음정렬순서_조회() throws Exception {
        ...
        // when
        ResultActions resultActions = mvc.perform(MockMvcRequestBuilders.get(URL + "/next-sort-seq"));
    ...
    void 인가_삭제() throws Exception {
        ...
        String url = URL + "/" + authorizationNo;
    ...
    private void deleteTestDatas() {
        authorizationRepository.deleteAll(testDatas);
