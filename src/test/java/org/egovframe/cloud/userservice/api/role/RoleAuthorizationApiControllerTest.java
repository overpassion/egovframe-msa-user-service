...
import org.egovframe.cloud.userservice.domain.role.*;
...
class RoleAuthorizationApiControllerTest {
    ...
    private final String ROLE_ID = "ROLE_1";
     ...
     * 테스트 데이터 등록
     */
    private void insertTestParentDatas() {
        // 권한 등록
     ...
     * 테스트 데이터 삭제
     */
    private void deleteTestParentDatas() {
        // 인가 삭제
